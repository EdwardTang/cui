...
export function WaveformVisualizer({ audioData, isRecording, isPaused }: WaveformVisualizerProps) {
  ...
  return (
    ...
    >
      <canvas ref={canvasRef} className="bg-transparent w-full" aria-hidden="true" />
    </div>
  );
}
