...
function InspectorApp() {
  ...
  const [permissionDecisionBody, setPermissionDecisionBody] = useState(
    JSON.stringify(
      {
        action: 'approve',
        modifiedInput: {},
  ...
  const startStream = async (id?: string) => {
    ...
    setStreamResult([
      <span key="connecting" className="text-green-400">
      ...
      while (true) {
        ...
        if (done) {
          setStreamResult((prev) => [
            ...prev,
            <span key="ended" className="text-neutral-500">
              [Stream ended]
            </span>,
          ]);
          break;
        ...
        for (const line of lines) {
          if (line.trim()) {
            ...
            const newLine = (
              <div
                key={`line-${lineCount}`}
                className="my-0.5 py-0.5 border-b border-dotted border-neutral-700"
              >
  ...
  const stopStream = () => {
    if (currentStream) {
      ...
      setStreamResult((prev) => [
        ...prev,
        <span key="stopped" className="text-yellow-300">
  ...
  const listPermissions = async () => {
    try {
      const data = await api.getPermissions({
        ...
        status: (permissionsStatus === 'all' ? undefined : permissionsStatus) as
          | 'pending'
          | 'approved'
          | 'denied'
          | undefined,
  ...
  const renameSession = async () => {
    try {
      ...
      if (continuationSessionId.trim() !== '')
        updateData.continuationSessionId = continuationSessionId.trim();
      if (initialCommitHead.trim() !== '') updateData.initialCommitHead = initialCommitHead.trim();
      if (sessionPermissionMode.trim() !== '' && sessionPermissionMode !== 'keep-current')
        updateData.permissionMode = sessionPermissionMode.trim();
  ...
  const transcribeAudio = async () => {
    try {
      ...
      if (geminiAudioFile) {
        ...
        showJson('geminiTranscribeResult', {
          error: 'Please provide an audio file or base64 data',
        });
      }
    } catch (e: any) {
    ...
    <div className="flex w-full h-screen min-h-0 font-mono bg-neutral-100 fixed top-0 left-0 right-0 bottom-0">
      ...
      <div className="w-[450px] bg-neutral-200 overflow-y-auto border-r-2 border-neutral-300 p-5 box-border min-h-0">
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.status && 'hidden')}>
            <Button onClick={getSystemStatus} className="bg-neutral-800 hover:bg-neutral-700">
              Get Status
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.statusResult && (
                <JsonViewer data={results.statusResult} resultId="statusResult" />
              )}
            </div>
            {results.statusResult && !results.statusResult.error && (
              <div className="mt-2.5 text-xs text-neutral-600">
                <div>
                  <strong>Claude Version:</strong> {results.statusResult.claudeVersion}
                </div>
                <div>
                  <strong>Claude Path:</strong> {results.statusResult.claudePath}
                </div>
                <div>
                  <strong>Config Path:</strong> {results.statusResult.configPath}
                </div>
                <div>
                  <strong>Active Conversations:</strong> {results.statusResult.activeConversations}
                </div>
                <div>
                  <strong>Machine ID:</strong> {results.statusResult.machineId}
                </div>
              </div>
            )}
          </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.config && 'hidden')}>
            <Button onClick={getConfig} className="bg-neutral-800 hover:bg-neutral-700">
              Get Config
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.configGetResult && (
                <JsonViewer data={results.configGetResult} resultId="configGetResult" />
              )}
            </div>
            ...
            <div className="mt-4 border-t border-neutral-300 pt-4">
              ...
              <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
                <Label
                  className="font-bold text-neutral-600 text-xs uppercase mb-1"
                  htmlFor="configUpdateBody"
                >
              ...
              <Button onClick={updateConfig} className="bg-neutral-800 hover:bg-neutral-700">
                Update Config
              </Button>
              <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
                {results.configUpdateResult && (
                  <JsonViewer data={results.configUpdateResult} resultId="configUpdateResult" />
                )}
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.workingDirs && 'hidden')}>
            <Button onClick={getWorkingDirectories} className="bg-neutral-800 hover:bg-neutral-700">
              Get Working Directories
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.workingDirsResult && (
                <JsonViewer data={results.workingDirsResult} resultId="workingDirsResult" />
              )}
            </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.commands && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <Label
                className="font-bold text-neutral-600 text-xs uppercase mb-1"
                htmlFor="commandsWorkingDir"
              >
                Working Directory <span className="text-neutral-400 text-[10px]">(optional)</span>
              </Label>
              <Input
                id="commandsWorkingDir"
                type="text"
                value={commandsWorkingDirectory}
                onChange={(e) => setCommandsWorkingDirectory(e.target.value)}
                placeholder="/path/to/working/directory"
                className="font-mono"
              />
            </div>
            <Button onClick={getCommands} className="bg-neutral-800 hover:bg-neutral-700">
              Get Commands
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.commandsResult && (
                <JsonViewer data={results.commandsResult} resultId="commandsResult" />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.start && 'hidden')}>
            ...
            <Button onClick={startConversation} className="bg-neutral-800 hover:bg-neutral-700">
              Start Conversation
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.startResult && (
                <JsonViewer data={results.startResult} resultId="startResult" />
              )}
            </div>
          </div>
        </div>
          ...
          <div className={cn('overflow-hidden', collapsed.stop && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              <Input
                id="stopStreamingId"
                type="text"
                value={stopStreamingId}
                onChange={(e) => setStopStreamingId(e.target.value)}
                placeholder="streaming-id"
                className="font-mono"
              />
            </div>
            <Button onClick={stopConversation} className="bg-neutral-800 hover:bg-neutral-700">
              Stop Conversation
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.list && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <div className="flex gap-2.5">
                <div className="flex-1">
                  <Label
                    className="font-bold text-neutral-600 text-xs uppercase mb-1"
                    htmlFor="conversationsLimit"
                  >
                    Limit <span className="text-neutral-400 text-[10px]">(optional)</span>
                  </Label>
                  <Input
                    id="conversationsLimit"
                    type="number"
                    value={sidebarConversationsLimit}
                    onChange={(e) => setSidebarConversationsLimit(e.target.value)}
                    placeholder="20"
                    className="font-mono"
                  />
                </div>
                <div className="flex-1">
                  <Label
                    className="font-bold text-neutral-600 text-xs uppercase mb-1"
                    htmlFor="conversationsOffset"
                  >
                    Offset <span className="text-neutral-400 text-[10px]">(optional)</span>
                  </Label>
                  <Input
                    id="conversationsOffset"
                    type="number"
                    value={sidebarConversationsOffset}
                    onChange={(e) => setSidebarConversationsOffset(e.target.value)}
                    placeholder="0"
                    className="font-mono"
                  />
                </div>
                <div className="flex-1">
                  <Label
                    className="font-bold text-neutral-600 text-xs uppercase mb-1"
                    htmlFor="conversationsProjectPath"
                  >
                    Project Path <span className="text-neutral-400 text-[10px]">(optional)</span>
                  </Label>
                  <Input
                    id="conversationsProjectPath"
                    type="text"
                    value={sidebarConversationsProjectPath}
                    onChange={(e) => setSidebarConversationsProjectPath(e.target.value)}
            ...
            <Button
              onClick={listConversationsSidebar}
              className="bg-neutral-800 hover:bg-neutral-700"
            >
              List Conversations
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.sidebarConversationsResult && (
                <JsonViewer
                  data={results.sidebarConversationsResult}
                  resultId="sidebarConversationsResult"
                />
              )}
            </div>
          </div>
          ...
          <div className={cn('overflow-hidden', collapsed.rename && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              >
                ...
                {availableSessions.map((session) => {
                  ...
                  if (
                    session.sessionInfo?.permission_mode &&
                    session.sessionInfo.permission_mode !== 'default'
                  )
                    sessionFlags.push(`🔒${session.sessionInfo.permission_mode}`);
                  ...
                  const metricsStr = metrics
                    ? ` [📝${metrics.editCount} ✏️${metrics.writeCount} +${metrics.linesAdded} -${metrics.linesRemoved}]`
                    : '';
                  return (
                    <option
                    ...
                    >
                      {session.sessionId.substring(0, 8)}... - {displayName.substring(0, 50)}...
                      {flagsStr}
                      {metricsStr} ({date})
                    </option>
                  );
              ...
              <Input
                ...
                value={renameSessionId}
                onChange={(e) => setRenameSessionId(e.target.value)}
                placeholder="claude-session-id or select from dropdown"
                className="font-mono"
              />
            </div>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              <Input
                ...
                placeholder="My Project Discussion"
                maxLength={200}
                className="font-mono"
              />
              <div className="text-xs text-neutral-600 mt-0.5">
            ...
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <div className="flex gap-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="sessionPinned"
                    checked={sessionPinned}
                    onCheckedChange={(checked) => setSessionPinned(checked as boolean)}
                  />
                  <Label htmlFor="sessionPinned" className="text-sm cursor-pointer">
                    Pinned
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="sessionArchived"
                    checked={sessionArchived}
                    onCheckedChange={(checked) => setSessionArchived(checked as boolean)}
                  />
                  <Label htmlFor="sessionArchived" className="text-sm cursor-pointer">
                    Archived
                  </Label>
                </div>
              </div>
            ...
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              <Input
                ...
                type="text"
                value={continuationSessionId}
                onChange={(e) => setContinuationSessionId(e.target.value)}
            ...
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <Label
                className="font-bold text-neutral-600 text-xs uppercase mb-1"
                htmlFor="initialCommitHead"
              >
                Initial Commit HEAD <span className="text-neutral-400 text-[10px]">(optional)</span>
              </Label>
              <Input
                id="initialCommitHead"
                type="text"
                value={initialCommitHead}
                onChange={(e) => setInitialCommitHead(e.target.value)}
            ...
            <Button onClick={renameSession} className="bg-neutral-800 hover:bg-neutral-700">
              Update Session
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.renameResult && (
                <JsonViewer data={results.renameResult} resultId="renameResult" />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.permissions && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <div className="flex gap-2.5">
                <div className="flex-1">
                  <Label
                    className="font-bold text-neutral-600 text-xs uppercase mb-1"
                    htmlFor="permissionsStreamingId"
                  >
                    Streaming ID <span className="text-neutral-400 text-[10px]">(optional)</span>
                  </Label>
                  <Input
                    id="permissionsStreamingId"
                    type="text"
                    value={permissionsStreamingId}
                    onChange={(e) => setPermissionsStreamingId(e.target.value)}
                    placeholder="streaming-id"
                    className="font-mono"
                  />
                </div>
            ...
            <Button onClick={listPermissions} className="bg-neutral-800 hover:bg-neutral-700">
              List Permissions
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.permissionsResult && (
                <JsonViewer data={results.permissionsResult} resultId="permissionsResult" />
              )}
            </div>
          </div>
        </div>
          ...
          <div className={cn('overflow-hidden', collapsed.permissionDecision && 'hidden')}>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              <Input
                ...
                type="text"
                value={permissionRequestId}
                onChange={(e) => setPermissionRequestId(e.target.value)}
            ...
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <Label
                className="font-bold text-neutral-600 text-xs uppercase mb-1"
                htmlFor="permissionDecisionBody"
              >
            ...
            <Button
              onClick={makePermissionDecision}
              className="bg-neutral-800 hover:bg-neutral-700"
            >
              Make Decision
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.permissionDecisionResult && (
                <JsonViewer
                  data={results.permissionDecisionResult}
                  resultId="permissionDecisionResult"
                />
              )}
            </div>
          </div>
              ...
              <div className="flex gap-4">
                <div className="flex items-center space-x-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) => setListRecursive(checked as boolean)}
                  />
                  <Label htmlFor="listRecursive" className="text-sm cursor-pointer">
                    Recursive
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <Checkbox
                    id="listRespectGitignore"
                    checked={listRespectGitignore}
                    onCheckedChange={(checked) => setListRespectGitignore(checked as boolean)}
                  />
                  <Label htmlFor="listRespectGitignore" className="text-sm cursor-pointer">
                    Respect .gitignore
                  </Label>
                </div>
              </div>
            </div>
            <Button onClick={listDirectory} className="bg-neutral-800 hover:bg-neutral-700">
              List Directory
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.readFile && 'hidden')}>
            ...
            <Button onClick={readFile} className="bg-neutral-800 hover:bg-neutral-700">
              Read File
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.bulkOperations && 'hidden')}>
            <div className="mb-2.5">
              ...
              <Button onClick={archiveAllSessions} className="bg-red-600 hover:bg-red-700">
                Archive All Sessions
              </Button>
              <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
                {results.archiveAllResult && (
                  <JsonViewer data={results.archiveAllResult} resultId="archiveAllResult" />
                )}
              </div>
            </div>
          </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.geminiHealth && 'hidden')}>
            <Button onClick={getGeminiHealth} className="bg-neutral-800 hover:bg-neutral-700">
              Check Gemini Health
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.geminiHealthResult && (
                <JsonViewer data={results.geminiHealthResult} resultId="geminiHealthResult" />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.geminiTranscribe && 'hidden')}>
            ...
            <Button onClick={transcribeAudio} className="bg-neutral-800 hover:bg-neutral-700">
              Transcribe Audio
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.geminiTranscribeResult && (
                <JsonViewer
                  data={results.geminiTranscribeResult}
                  resultId="geminiTranscribeResult"
                />
              )}
            </div>
          </div>
        ...
        <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
          ...
          <div className={cn('overflow-hidden', collapsed.geminiSummarize && 'hidden')}>
            ...
            <Button onClick={summarizeText} className="bg-neutral-800 hover:bg-neutral-700">
              Summarize Text
            </Button>
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.geminiSummarizeResult && (
                <JsonViewer data={results.geminiSummarizeResult} resultId="geminiSummarizeResult" />
              )}
            </div>
          </div>
        </div>
          ...
          <div className={cn('overflow-hidden', collapsed.notifications && 'hidden')}>
            <div className="flex flex-col gap-2 mb-2">
              <Button
                ...
                className="bg-neutral-800 hover:bg-neutral-700 w-full"
              >
                Get Status
              </Button>
              <Button onClick={registerPush} className="bg-neutral-800 hover:bg-neutral-700 w-full">
                Register Push
              </Button>
              <Button
            ...
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.notificationsStatus && (
                <JsonViewer data={results.notificationsStatus} resultId="notificationsStatus" />
              )}
              {results.notificationsRegister && (
                <JsonViewer data={results.notificationsRegister} resultId="notificationsRegister" />
              )}
              {results.notificationsUnregister && (
                <JsonViewer
                  data={results.notificationsUnregister}
                  resultId="notificationsUnregister"
                />
              )}
              {results.notificationsTest && (
                <JsonViewer data={results.notificationsTest} resultId="notificationsTest" />
              )}
            </div>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden relative">
        <div className="flex-1 overflow-y-auto p-0 box-border min-h-0">
          ...
          <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
            <div className="font-bold text-blue-600 text-sm mb-4">
              GET /api/conversations/:sessionId
            </div>
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              <Label
                className="font-bold text-neutral-600 text-xs uppercase mb-1"
                htmlFor="detailSessionId"
              >
                Session ID <span className="text-red-500">*</span>
              </Label>
              <select
            ...
            <div className="max-h-96 overflow-auto border border-neutral-300 rounded bg-neutral-50 p-2.5 mt-2.5">
              {results.detailsResult && (
                <JsonViewer data={results.detailsResult} resultId="detailsResult" />
              )}
            </div>
          </div>
          ...
          <div className="bg-white border-t border-b border-neutral-300 p-4 mb-0">
            ...
            <div className="my-2.5 p-2.5 bg-neutral-50 rounded">
              ...
              <Input
                ...
                type="text"
                value={streamingId}
                onChange={(e) => setStreamingId(e.target.value)}
                placeholder="streaming-id"
                className="font-mono"
              />
            </div>
            <div className="flex gap-2">
              <Button onClick={() => startStream()} className="bg-neutral-800 hover:bg-neutral-700">
                Start Stream
              </Button>
              <Button onClick={stopStream} className="bg-neutral-800 hover:bg-neutral-700">
                Stop Stream
              </Button>
              <Button onClick={clearStream} className="bg-neutral-800 hover:bg-neutral-700">
                Clear
              </Button>
              <Button
                onClick={(e) => copyStreamToClipboard(e.currentTarget)}
                className="bg-neutral-800 hover:bg-neutral-700"
              >
                Copy Stream
              </Button>
            ...
            <div
              className="bg-neutral-900 text-neutral-300 p-2.5 rounded mt-2.5 max-h-96 overflow-auto text-xs leading-relaxed"
              ref={streamResultRef}
            >
              {streamResult}
            </div>
