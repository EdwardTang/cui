...
// Stream event types
// Podcast-specific stream message types
export interface PodcastProgressMessage {
  type: 'system';
  subtype: 'progress';
  streaming_id: string;
  timestamp: string;
...
export interface PodcastCompletedMessage {
  type: 'system';
  subtype: 'completed';
  streaming_id: string;
  timestamp: string;
...
export type StreamEvent =
  ...
  | UserStreamMessage
  | ResultStreamMessage
  | PodcastProgressMessage
  | PodcastCompletedMessage;
